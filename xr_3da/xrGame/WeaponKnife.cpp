...
///	FireTrace(pos,dir);
	...
	Level().BulletManager().AddBullet(	pos, dir, m_fStartBulletSpeed, float(fHitPower),
...
void CWeaponKnife::LoadFireParams		(LPCSTR section, LPCSTR prefix)
{
	...
	iHitPower_1			= fHitPower;
	fHitImpulse_1		= fHitImpulse;
	m_eHitType_1		= ALife::g_tfString2HitType(pSettings->r_string(section, "hit_type"));
	
	iHitPower_2			= pSettings->r_s32		(section,strconcat(sizeof(full_name),full_name,prefix,"hit_power_2"));
